      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
                ...
                <tr key={s.ticker} className="hover:bg-slate-700/20 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span className="w-12 text-right font-mono text-slate-400 text-xs">{w.toFixed(1)}%</span>
                    </div>
                  </td>
                </tr>
              )
          ...
          <tfoot className="bg-slate-900/50">
            <tr>
              <td colSpan={2} className="px-6 py-3 font-semibold text-slate-400">Total</td>
